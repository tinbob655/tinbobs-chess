...
public class GameConfig {
    ...
    @Bean
    public GameEngine gameEngine(Human human, Bot bot, MoveParser moveParser, CreateFrontendStatus statusCreator, GameEventPublisher publisher, Evaluator evaluator) {
        GameEngine engine = new GameEngine(moveParser, statusCreator, publisher, evaluator);
